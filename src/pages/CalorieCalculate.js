                        ...
                        <Card.Body>
                            <Card.Text>
                                <ListGroup>
                                    ...
                                    <ListGroup.Item>如果你想減去體脂肪 / 體重： 你應該<u class="font-weight-bold">減少15%的熱量攝取</u>，即是將你的熱量攝取量乘以85%。以上述男性運動員為例，即他每日應攝取3050 x 0.85 ＝2593卡路里。</ListGroup.Item>
                                    <ListGroup.Item>如你想增加體重 / 肌肉：那麼你應<u class="font-weight-bold">增加20%的熱量</u>。以該男運動員為例，即每日應攝取3050 x 1.2 ＝3660卡路里。</ListGroup.Item>                                    
                                </ListGroup>
                            </Card.Text>
                        </Card.Body>
                    </Card>
