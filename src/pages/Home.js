...
function HomePage() {
  return (
    <section>
      <span style={{ margin: '1rem' }}>Last Updated: 2021/10/07</span>
      <ListGroup className="m-2">
        <ListGroup.Item action className="pt-4 border-bottom-0"><Link to='/bmi'>BMI 計算</Link></ListGroup.Item>
        <ListGroup.Item action className="border-bottom-0"><Link to='/calorie-calculate'>每日熱量需求量 (TDEE)</Link><hr className="mt-3 mb-0"/></ListGroup.Item>

        <ListGroup.Item action className="border-bottom-0"><Link to='/blood-pressure-high'>高血壓迷思</Link></ListGroup.Item>
        ...
        <ListGroup.Item action className="border-bottom-0"><Link to='/tip3'>減肥亦保持靚靚皮膚</Link><hr className="mt-3 mb-0"/></ListGroup.Item>
